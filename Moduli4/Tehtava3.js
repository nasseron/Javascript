...
document.getElementById('searchForm').addEventListener('submit', async function(event) {
    ...
    try {
        ...
        data.forEach(tvShow => {
            ...
            // Create an img element for the image (using optional chaining for missing images)
            const imageElement = document.createElement('img');
            imageElement.src = tvShow.show.image?.medium || ''; // If image is missing, use empty string
